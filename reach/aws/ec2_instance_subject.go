...
// NewEC2InstanceSubjectWithRole returns a new subject for the specified EC2 instance and sets the specified subject role.
func NewEC2InstanceSubjectWithRole(id string, role reach.SubjectRole) (*reach.Subject, error) {
...
func NewEC2InstanceSubject(id string) *reach.Subject {
	return &reach.Subject{
		Domain: ResourceDomainAWS,
		Kind:   SubjectKindEC2Instance,
		ID:     id,
